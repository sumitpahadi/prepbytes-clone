        ...
        <Carousel responsive={responsive}>
          <div className="carsual-container">
            <div className="carsual">
              <img
                src="https://prepbytes-misc-images.s3.ap-south-1.amazonaws.com/full-stack/testimonial/Shivam+Gupta.svg"
                alt=""
              />
              <h4>Shivam Gupta</h4>
            </div>
          ...
          <div className="carsual-container">
            <div className="carsual">
              <img
                src="https://prepbytes-misc-images.s3.ap-south-1.amazonaws.com/full-stack/testimonial/shivani+Ravi.svg"
                alt=""
              />
              <h4>Shivani Ravi</h4>
            </div>
          ...
          <div className="carsual-container">
            <div className="carsual">
              <img
                src="https://prepbytes-misc-images.s3.ap-south-1.amazonaws.com/full-stack/testimonial/Abhishek+Kumar.svg"
                alt=""
              />
          ...
          <div className="carsual-container">
            <div className="carsual">
              <img
                src="https://prepbytes-misc-images.s3.ap-south-1.amazonaws.com/full-stack/testimonial/Nikhil.svg"
                alt=""
              />
              <h4>Nikhil</h4>
            </div>
