  ...
  return (
    <div>
      <div className="top-container-frequent">
        <button
          className={`frequent ${selectedButton === 1 ? "selected" : ""}`}
          onClick={() => {
            handleButtonClick(1);
            handleelegiblity();
          }}
        ...
        <button
          className={`frequent ${selectedButton === 2 ? "selected" : ""}`}
          onClick={() => {
            handleButtonClick(2);
            handlebatch();
          }}
        ...
        <button
          className={`frequent ${selectedButton === 3 ? "selected" : ""}`}
          onClick={() => {
            handleButtonClick(3);
            handleplacement();
          }}
      ...
      {createria === 1 && (
        <div className="top-cont">
          <button onClick={question1} className="question">
            Can I apply if I am still in College? <p>{ques1 ? "-" : "+"}</p>
          </button>
          {ques1 && (
          ...
          <button onClick={question2} className="question">
            Can I apply if I am from non cse branch? <p>{ques2 ? "-" : "+"}</p>
          </button>
          {ques2 && (
            <div className="answer">
              <p>
                Yes, if you are willing to work hard on your coding skills, you
                can apply.
              </p>
            </div>
          )}
          ...
          <button onClick={question3} className="question">
            Do I need to have strong coding skills? <p>{ques3 ? "-" : "+"}</p>
          </button>
          {ques3 && (
            <div className="answer">
              <p>
                No, you do not need to have strong coding skills. You just need
                to have good fundamentals and willingness to work hard.
              </p>
            </div>
          )}

          <button onClick={question4} className="question">
            How can I apply?<p>{ques4 ? "-" : "+"}</p>
          </button>
          {ques4 && (
            <div className="answer">
              <p>
                Click on apply button on the top banner and fill the complete
                application form.
              </p>
            </div>
          )}
