          ...
          return (
            <div className="slider" key={index}>
              <div className="namedesign">
                <img
                  src="https://s3.ap-south-1.amazonaws.com/www.prepbytes.com/coursePageNew/zenithWebp/Quote1.webp"
                  alt=""
                />
                <h3>{item.name}</h3>
              </div>
              ...
              <img
                src="https://s3.ap-south-1.amazonaws.com/www.prepbytes.com/coursePageNew/zenithWebp/Quote2.webp"
                className="design"
                alt=""
              />
            </div>
