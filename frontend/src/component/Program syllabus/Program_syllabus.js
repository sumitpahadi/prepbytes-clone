    ...
    <div>
      <div className="heading-project">
        <div className="inner-heading-project1 syllabus-head">
          ...
          <p>
            Learn from the best and be prepared to crack full <br /> stack
            developer jobs
          </p>
        </div>
      </div>
      <div className="syllabues">
        ...
        <div className="syllabus-detail" style={{ borderLeft: "10px solid rgb(247, 128, 119)", borderRadius: "9px" }}>
          ...
          style={{
            ...
            borderRadius: "9px",
            color: "white",
            backgroundColor: "rgb(247, 128, 119)",
        ...
        </p> <h2>Frontend Development Basics</h2>
            </div>

            <p class="d-inline-flex gap-1">
              <button
                className="btn btn-primary sylbutton"
                type="button"
        ...
        <div className="syllabus-detail" style={{ borderLeft: "10px solid rgb(101, 187, 229)", borderRadius: "9px" }}>
          ...
          style={{
            ...
            borderRadius: "9px",
            color: "white",
            backgroundColor: "rgb(101, 187, 229)",
        ...
        <div className="syllabus-detail" style={{ borderLeft: "10px solid rgb(247, 182, 67)", borderRadius: "9px" }}>
          ...
          style={{
            ...
            borderRadius: "9px",
            color: "white",
            backgroundColor: "rgb(247, 182, 67)",
...
export default Program_syllabus;
