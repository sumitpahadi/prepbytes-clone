...
function Curriculum() {
  ...
  return (
    <>
    <h1 style={{textAlign:"center",marginTop:"40px"}}>Curriculum</h1>
    <div className="Curriculum">
      ...
      <div className="inner-Curriculum">
        ...
        <div className="curculam-img">
          <img
            src="https://s3.ap-south-1.amazonaws.com/www.prepbytes.com/coursePageNew/zenithWebp/Curriculum-Image.webp"
            alt=""
            />
        </div>
      </div>
